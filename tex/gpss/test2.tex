...
%\global\long\def\newsection#1#2{\title{#1}\frame{\maketitle}\section{#1}\begin{frame}\frametitle{Outline}\tableofcontents[currentsection,hideallsubsections]\end{frame}\begin{frame}\frametitle{Outline}\tableofcontents[currentsection,hideothersubsections]\end{frame}\includetalkfile{#2}}



\global\long\def\inputVals{\inputVector}
...
\input{../../../gp/tex/talks/overdeterminedGp.tex}
\input{../../../gp/tex/talks/underdeterminedGp.tex}
\begin{frame}
...
% \input{../../../kern/tex/talks/rbfcovariance}
...
%\input{../../../kern/tex/talks/covfuncSamples}
...
\input{../../../kern/tex/talks/markovcovariance}
\input{../../../kern/tex/talks/markovprecision}
\input{../../../kern/tex/talks/rbfcovariance}
\input{../../../kern/tex/talks/rbfprecision}
\input{../../../kern/tex/talks/markovprecision}
\input{../../../gp/tex/talks/gpKalmanFilterKronecker}
\input{../../../multigp/tex/talks/gpKalmanToMultiTask}
...
\global\long\def\inputVals{\latentVector}
...
\global\long\def\returnLabel{extensionsReturn}
